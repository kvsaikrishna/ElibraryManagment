<%@ Page Title="Member Managment" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagment.aspx.cs" Inherits="TestApp.adminmembermanagment" %>
                             ...
                             <div class="col-md-3">
                               <label>Member ID:</label>
                                <div class="form-group">
                                    ...
                                    <asp:LinkButton Class="btn btn-primary btn-sm" ID="LinkButton4"
                               ...
                               <label>Account Status:</label>
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control" ID="TextBox7"
                                        ...
                                        <asp:LinkButton Class="btn btn-success mr-1 btn-sm" ID="LinkButton1"
                                             runat="server" OnClick="LinkButton1_Click"><i class="fas fa-check-circle" ></i></asp:LinkButton>

                                        <asp:LinkButton Class="btn btn-warning mr-1 btn-sm" ID="LinkButton2"
                                             runat="server" OnClick="LinkButton2_Click"><i class="far fa-pause-circle" ></i></asp:LinkButton>

                                        <asp:LinkButton Class="btn btn-danger mr-1 btn-sm" ID="LinkButton3"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label>Full Address:</label>
                                 <asp:TextBox CssClass="form-control" ID="TextBox12"
                                  runat="server" placeholder="Address" ReadOnly="True" 
                         ...
                         <div class="row">
                            <div class="col-8 mx-auto">
                               <asp:Button Class="btn btn-danger btn-lg btn-block mt-2 " ID="Button2" 
